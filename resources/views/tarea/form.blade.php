<div class="card col-md-5">
    ...
    <div class="card-body">
        ...
        <div class="form-group">
            ...
            <input type="text" required name="txtTarea" id="txtTarea" class="form-control"
                placeholder="Nombre de la tarea" aria-describedby="helpId"
                value="{{ isset($tarea->nombre_tariea) ? $tarea->nombre_tariea : old('txtTarea') }}">
        </div>
        <div class="form-group">
            <label for="txtDesc">Descripcion</label>
            <input type="text" required name="txtDesc" id="txtDesc" class="form-control"
...
{{--         <div class="form-group">
        ...
        <div class="form-group">
            ...
            <select class="form-control" name="txtEstado" id="txtEstado">
                <option selected required value="{{ isset($tarea->nombre_tariea) ? $tarea->estado_tarea : '' }}">
                    {{ isset($tarea->nombre_tariea) ? $tarea->estado_tarea : 'Seleccione' }}</option>
        ...
        <div class="form-group">
            ...
            <input type="text" required name="txtFechaV" id="txtFechaV" class="form-control" placeholder=""
                aria-describedby="helpId"
                value="{{ isset($tarea->nombre_tariea) ? $tarea->fecha_vencimiento : old('txtFechaV') }}">
        </div>
    </div>
